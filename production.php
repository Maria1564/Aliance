        ...
        <div class="container">
            <div class="header-navbar-content">
                <div class="about-content">
                    ...
                    <h1 class="section-title title-navbar">Контрактное производство</h1>
                    <ul class="breadcrumbs">
                        <li class="item-breadcrumbs">Главная</li>
                        <li class="item-breadcrumbs last-item">Контрактное производство</li>
                    </ul>
                </div>
                <img src="./img/avto-him.svg" alt="avto-him" class="avto-him">
            </div>
